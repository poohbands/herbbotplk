...
- **แหล่งข้อมูล แหล่งอ้างอิง และฐานข้อมูลที่ระบบใช้ (System Knowledge Sources & Verification):** ที่มาของข้อมูลอันตรกิริยา แหล่งตรวจสอบย้อนกลับ (ม.มหิดล, บัญชียาหลักฯ, 10 กลุ่มอาการ สธ., PubMed, ThaiJO, ทีมเภสัชกร สสจ.พิษณุโลก) **ต้องตอบอย่างละเอียดและชัดเจน ห้ามปฏิเสธเด็ดขาด**
