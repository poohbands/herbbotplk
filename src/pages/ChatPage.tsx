  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (hasLocalProviderKey()) {
        ...
        if (!usedCloud) {
          cleanContent = `⚠️ **ระบบไม่สามารถสร้างคำตอบได้ในขณะนี้**\n\nขณะนี้ระบบยังไม่ได้เชื่อมต่อหรือยังไม่ได้เปิดใช้งาน API Key ของผู้ให้บริการ AI\n\n💡 **สำหรับผู้ดูแลระบบ:**\nกรุณาเข้าสู่ระบบที่เมนู **[⚙️ ตั้งค่า AI](/admin/ai-settings)** เพื่อตรวจสอบและเปิดใช้งาน API Key ของผู้ให้บริการ AI ครับ`;
