...
| **มะขามป้อม (สมุนไพรเดี่ยว)** | บรรเทาอาการไอ ขับเสมหะ ทำให้ชุ่มคอ | ไม่พบข้อมูลขนาดและวิธีใช้ที่ชัดเจนในฐานความรู้ที่ใช้อ้างอิง | ในฐานความรู้อ้างอิงไม่ระบุข้อห้าม ข้อควรระวัง หรืออันตรกิริยากับยาแผนปัจจุบันไว้โดยตรง | ฐานข้อมูลสมุนไพรเดี่ยว กลุ่มงานการแพทย์แผนไทยและสมุนไพร สสจ.พิษณุโลก |
