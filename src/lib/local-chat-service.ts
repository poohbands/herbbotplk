...
export function buildSystemPrompt(settings?: KnowledgeSettings): string {
  ...
  const herbBooksApaRule = enableHerbBooks
    ? `    - กรณีอ้างอิงหนังสือและแนวทางเวชปฏิบัติ (CPG กรมการแพทย์ 2568, ยาสมุนไพรทดแทนยาแผนปัจจุบัน 32 รายการ สธ., แผนภูมิปฐมภูมิ ICD-10, บัญชียาหลัก 2568, CD 10 กลุ่มโรค, แผ่นภาพสรุป 10 กลุ่มอาการ/19 ยาทดแทน สสจ.บุรีรัมย์ - ให้อ้างอิงทุกเล่มที่นำมาใช้ตอบจริง โดยใส่ตัวเลขลำดับ 1., 2., 3. ด้านหน้าเสมอ):
      ...
      5. กรมการแพทย์แผนไทยและการแพทย์ทางเลือก. (2567). *ชุดข้อมูลความรู้การใช้ยาสมุนไพรใน 10 กลุ่มโรคและกลุ่มอาการพบบ่อย*. กระทรวงสาธารณสุข.
