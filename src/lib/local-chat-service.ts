...
export function buildSystemPrompt(settings?: KnowledgeSettings): string {
  ...
  const apaSectionBlock = showApa
    ...
    - **ก่อนจบคำตอบ ให้เขียนหัวข้อ "### 📚 เอกสารอ้างอิง (APA 7th Edition)"** แล้วระบุรายการอ้างอิงตามรูปแบบมาตรฐาน APA 7 เฉพาะรายการเอกสารต้นทางหรือวิจัยที่เกี่ยวข้องโดยตรงกับคำถามและนำมาใช้ตอบจริง:
      - **กฎสำคัญที่สุดเรื่องการอ้างอิงทุกแหล่งข้อมูลที่นำมาใช้ตอบ (All-Source APA Citations):** ในหัวข้อ "### 📚 เอกสารอ้างอิง (APA 7th Edition)" ต้องเขียนรายการเอกสารอ้างอิงของ**ทุกแหล่งข้อมูลที่ระบบนำมาใช้ตอบจริงให้ครบถ้วน** โดยเรียงลำดับตัวเลข 1., 2., 3. ให้ตรงกับ [1], [2], [3] ในเนื้อหา ระบุแหล่งข้อมูลหลัก (Primary Source [1]) เป็นอันดับแรกเสมอ และตามด้วยแหล่งข้อมูลเสริม ([2], [3]) ทั้งหมดที่นำมาใช้ตอบจริง
