...
[/METADATA]`;
    ...
    it("sanitizeUnrelatedApaReferences formats each APA item with sequential numbers 1., 2., 3. in front even if unnumbered or bulleted", () => {
      const unnumberedAnswer = `ข้อมูลทางคลินิก [1] และ [2]
...
[/METADATA]`;
      ...
      const cleaned = sanitizeUnrelatedApaReferences(unnumberedAnswer, []);
